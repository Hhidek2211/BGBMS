            ...
            @csrf
                <div class="flex flex-wrap md:mx-20 my-3 text-left space-y-1 md:space-y-0">
                    <div id="name" class="w-full mx-2 md:w-3/4 md:mr-1">
                        ...
                        <input class="w-full" type="text" name="edituser[name]" value="{{ old('edituser.name') }}">
                    ...
                    <div id="grade" class="w-full mx-2 md:mr-1 md:w-1/5">
                        ...
                        <input class="w-full" type="number" name="edituser[grade]" value="{{ old('edituser.grade') }}">
                ...
                <div class="flex flex-wrap md:mx-20 my-3 text-left space-y-1 md:space-y-0">
                    ...
                    <div id="introduction" class="w-full md:w-3/5 mx-2">
                        ...
                        <textarea class="w-full h-5/6" type="text" name="edituser[introduction]" value="{{ old('edituser.introduction') }}"></textarea>
                ...
                <input class="mt-8 mb-3" type="submit" value="作成する">
            </form>
        </div>
    </body>
</html>
